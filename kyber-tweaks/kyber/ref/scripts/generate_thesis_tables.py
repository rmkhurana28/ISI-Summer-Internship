...
if not os.path.exists("results"):
    ...
    print("Please run: ./scripts/run_all_tests.sh")
    sys.exit(1)

print("KYBER PARAMETER TWEAKS - PERFORMANCE ANALYSIS RESULTS")
print("=" * 100)
...
# Kyber512 baseline (same as standard - test1 has standard eta for 512)
...
# Kyber768 baseline - USE BASELINE RESULTS (standard η1=2, η2=2)
...
# Kyber1024 baseline - USE BASELINE RESULTS (standard η1=2, η2=2)
